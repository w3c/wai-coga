...
footer: >   # Translate words below, including "Date:" and "Editor:". (Do not update the date.)
   ...
   <p>Drafted by the Cognitive and Learning Disabilities Task Force (<a href="/WAI/GL/task-forces/coga/">CoGa TF</a>) for the Accessible Platform Architecture Working Group (<a href="https://www.w3.org/WAI/GL/">APA</a>) and Accessibility Guidelines Working Group (<a href="https://www.w3.org/WAI/APA/">AGWG</a>) with support from the <abbr title="European Commission">EC</abbr> <a href="https://www.easyreading.eu/2>Easy Reading project</a>.</p>
---
